<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TreeAccessory.ascx.cs" Inherits="SCMCore.Admin.UserControl.TreeAccessory" %>
...
<div style="direction: ltr">
    <asp:UpdatePanel runat="server" ID="updatepanelPopover">
        <ContentTemplate>
            ...
            <asp:Repeater runat="server" ID="rptAccessoryCategory" ClientIDMode="AutoID">
                <ItemTemplate>
                    <asp:HiddenField runat="server" ID="hfIDAccessoryCategory" Value='<%#Eval("IDAccessoryCategory") %>' />
